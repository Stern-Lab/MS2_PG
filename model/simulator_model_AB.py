...
def get_modelA_priors(sampled_params):
    model_priors_dict = {'mu': sampled_params[0], 'w_syn': sampled_params[1], 'w_nonsyn_mat': sampled_params[2],
                         'w_nonsyn_cp': sampled_params[3], 'w_nonsyn_lys': sampled_params[4],
                         'w_nonsyn_rep': sampled_params[5], 'w_ada': sampled_params[6], 'p_ada_syn': sampled_params[7],
                         'p_ada_ns_mat': sampled_params[8], 'p_ada_ns_cp': sampled_params[9],
                         'p_ada_ns_lys': sampled_params[10], 'p_ada_ns_rep': sampled_params[11],
                         'p_mat_nonsyn_rec': 0, 'p_cp_nonsyn_rec': 0,
                         'p_lys_nonsyn_rec': 0, 'p_rep_nonsyn_rec': 0}
    return model_priors_dict


def get_modelB_priors(sampled_params, nonsyn_fitness_lst):
    model_priors_dict = {'mu': sampled_params[0], 'w_syn': sampled_params[1],
                         'w_nonsyn_mat': nonsyn_fitness_lst[0],
                         'w_nonsyn_cp': nonsyn_fitness_lst[1],
                         'w_nonsyn_lys': nonsyn_fitness_lst[2],
                         'w_nonsyn_rep': nonsyn_fitness_lst[3], 'w_ada': sampled_params[2],
                         'p_ada_syn': sampled_params[3],
                         'p_ada_ns_mat': sampled_params[4], 'p_ada_ns_cp': sampled_params[5],
                         'p_ada_ns_lys': sampled_params[6], 'p_ada_ns_rep': sampled_params[7],
                         'p_mat_nonsyn_rec': sampled_params[8], 'p_cp_nonsyn_rec': sampled_params[9],
                         'p_lys_nonsyn_rec': sampled_params[10], 'p_rep_nonsyn_rec': sampled_params[11]}
    return model_priors_dict
...
def simulate(
    ...
    try:
        ...
        mat_probs_lst = get_mut_type_probs_per_gene_lst_simp_model(
            p_mat_syn, model_priors_dict['p_ada_syn'], model_priors_dict['p_ada_ns_mat'],
            model_priors_dict['p_mat_nonsyn_rec']
        )
        cp_probs_lst = get_mut_type_probs_per_gene_lst_simp_model(
            p_cp_syn, model_priors_dict['p_ada_syn'], model_priors_dict['p_ada_ns_cp'],
            model_priors_dict['p_cp_nonsyn_rec']
        )
        lys_probs_lst = get_mut_type_probs_per_gene_lst_simp_model(
            p_lys_syn, model_priors_dict['p_ada_syn'], model_priors_dict['p_ada_ns_lys'],
            model_priors_dict['p_lys_nonsyn_rec']
        )
        rep_probs_lst = get_mut_type_probs_per_gene_lst_simp_model(
            p_rep_syn, model_priors_dict['p_ada_syn'], model_priors_dict['p_ada_ns_rep'],
        ...
        print(f"got prot probs p0", flush=True)
        ...
        fitness_effects = np.array(
            [model_priors_dict['w_syn'], model_priors_dict['w_nonsyn_mat'], model_priors_dict['w_nonsyn_cp'],
             model_priors_dict['w_nonsyn_lys'], model_priors_dict['w_nonsyn_rep'],
             model_priors_dict['w_ada']])  # MAP_w_syn, MAP_w_nonsyn
        ...
        mutations = get_mutations(
            model_priors_dict['mu'], mutation_type_probs_per_gene_lst, gene_probs, freq_threshold, simplified
        )
        ...
        if long_sumstat:
            ...
            data = get_expanded_sumstat_simplified(data, [i for i in range(0, passages + 1)])
